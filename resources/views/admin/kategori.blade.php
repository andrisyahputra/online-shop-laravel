...
<div class="card">
    <div class="card-body">
        ...
        <div class="d-flex mb-4">
            <button class="btn btn-primary ms-auto me-0" data-bs-toggle="modal" data-bs-target="#add_category"> <i class="bi bi-plus-lg"></i>
                Tambah Kategori
            </button>
        </div>
        ...
        <div class="modal-content">
            <form action="{{ route('kategori.store') }}" method="POST" id="form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="send_form('#form')" id="btn_submit"> <i class="bi bi-files"></i> Simpan</button>
                </div>
